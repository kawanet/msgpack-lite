...
function readUInt64BE(start) {
  return BufferLite.readUInt64BE.call(this, start).toNumber();
}

function readInt64BE(start) {
  return BufferLite.readInt64BE.call(this, start).toNumber();
}
