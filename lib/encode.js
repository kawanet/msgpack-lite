...
function init(encoder) {
  ...
  // bin 16 -- 0xc5
  // bin 32 -- 0xc6
  encoder[0xc4] = pair(0xc4, uint8);
  encoder[0xc5] = pair(0xc5, uint16);
  encoder[0xc6] = pair(0xc6, uint32);

  // ext 8 -- 0xc7
  // ext 16 -- 0xc8
  // ext 32 -- 0xc9
  encoder[0xc7] = pair(0xc7, uint8);
  encoder[0xc8] = pair(0xc8, uint16);
  encoder[0xc9] = pair(0xc9, uint32);

  // float 32 -- 0xca
  // float 64 -- 0xcb
  encoder[0xca] = pair(0xca, float32);
  encoder[0xcb] = pair(0xcb, float64);

  // uint 8 -- 0xcc
  // uint 16 -- 0xcd
  // uint 32 -- 0xce
  // uint 64 -- 0xcf
  encoder[0xcc] = pair(0xcc, uint8);
  encoder[0xcd] = pair(0xcd, uint16);
  encoder[0xce] = pair(0xce, uint32);
  encoder[0xcf] = pair(0xcf, empty64);

  // int 8 -- 0xd0
  // int 16 -- 0xd1
  // int 32 -- 0xd2
  // int 64 -- 0xd3
  encoder[0xd0] = pair(0xd0, int8);
  encoder[0xd1] = pair(0xd1, int16);
  encoder[0xd2] = pair(0xd2, int32);
  encoder[0xd3] = pair(0xd3, empty64);
  ...
  // map 16 -- 0xde
  // map 32 -- 0xdf
  encoder[0xd9] = pair(0xd9, uint8);
  encoder[0xda] = pair(0xda, uint16);
  encoder[0xdb] = pair(0xdb, uint32);
  encoder[0xdc] = pair(0xdc, uint16);
  encoder[0xdd] = pair(0xdd, uint32);
  encoder[0xde] = pair(0xde, uint16);
  encoder[0xdf] = pair(0xdf, uint32);
}
...
function boolean(value) {
  ...
  return msg[type].call(this, value);
}
