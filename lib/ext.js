...
Ext("B", "Boolean").parser(Number).builder(create(Boolean));
...
// ErrorType
Ext(0x10, "Error").parser(map(exports.Error)).builder(buildError);
Ext(0x11, "EvalError").parser(map(exports.Error)).builder(buildError);
Ext(0x12, "RangeError").parser(map(exports.Error)).builder(buildError);
Ext(0x13, "ReferenceError").parser(map(exports.Error)).builder(buildError);
Ext(0x14, "SyntaxError").parser(map(exports.Error)).builder(buildError);
Ext(0x15, "TypeError").parser(map(exports.Error)).builder(buildError);
Ext(0x16, "URIError").parser(map(exports.Error)).builder(buildError);
...
if ("undefined" !== typeof Uint8Array) {
  ...
  Ext(0x0A, "ArrayBuffer").encoder(encodeArrayBuffer).decoder(decodeArrayBuffer);
  Ext(0x0D, "DataView").encoder(encodeTypedArray).decoder(decodeArrayBuffer, create(DataView));
}
