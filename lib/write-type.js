...
exports.type = getWriteType();

function getWriteType(options) {
  if (!options && exports.type) return exports.type; // default
  ...
  function array(encoder, value) {
    ...
    for (var i = 0; i < length; i++) {
      encoder.codec.encode(encoder, value[i]);
    }
  }
  ...
  function map(encoder, value) {
    ...
    keys.forEach(function(key) {
      encoder.codec.encode(encoder, key);
      encoder.codec.encode(encoder, value[key]);
    });
  }
