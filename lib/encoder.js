...
function encode(encoder, value) {
  var func = encoders[typeof value] || NA;
  func(encoder, value);
}

function NA(encoder, value) {
...
var serializers = {};
serializers["[object Date]"] = [0x44, Number];
serializers["[object RegExp]"] = [0x52, function(value) {
...
function object(encoder, value) {
  ...
  if (value === null) {
    ...
    var s = serializers[Object.prototype.toString.call(value)];
    if (s) {
      // ext 1 -- 0xd4
      // ext 2 -- 0xd5
      // ext 4 -- 0xd6
      ...
      // ext 16 -- 0xc8
      // ext 32 -- 0xc9
      value = s[1](value); // convert to primitive values
      value = _encode(value); // encode to buffer
      length = value.length;
      type = extmap[length] || ((length < 0xFF) ? 0xc7 : (length <= 0xFFFF) ? 0xc8 : 0xc9);
      token[type](encoder, length);
      constant[s[0]](encoder);
      encoder.write(value);
      return;
    }
