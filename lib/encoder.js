...
var extencoders = require("./ext").encoders;
...
var FUNCTION_HAS_NAME = Encoder.name;
...
function encode(encoder, value) {
  var func = types[typeof value] || NA;
  func(encoder, value);
}

function NA(encoder, value) {
  throw new Error("Unknown supported type \"" + (typeof value) + "\": " + value);
}
...
function object(encoder, value) {
  ...
  if (value === null) {
    ...
    if (!n && !FUNCTION_HAS_NAME && value instanceof ExtBuffer) n = "ExtBuffer";
    var e = extencoders[n];
    if (e) {
      // fixext 1 -- 0xd4
      // fixext 2 -- 0xd5
